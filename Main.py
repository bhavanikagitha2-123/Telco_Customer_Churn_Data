...
class TELCO_CHURN():
    def __init__(self, path, logger):
        ...
        self.logger.info(f" Data loaded successfull : {self.df.shape}")
...
if __name__ == "__main__":
    path = r"C:\Users\BHAVANI\Downloads\internship telco_customer_churn\WA_Fn-UseC_-Telco-Customer-Churn.csv"
